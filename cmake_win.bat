set HSAIL_TOOLS=C:/GIT/HSAIL-Tools
set HSA_RUNTIME_INC=C:/p4/hsa/drivers/hsa/runtime/inc
set HSA_RUNTIME_EXT_INC=C:/p4/hsa/drivers/hsa/compiler/finalizer/Interface
set OCL_PATH=C:/p4/hsa/drivers/opencl/dist/windows/debug
