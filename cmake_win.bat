...
set HSA_RUNTIME_INC=F:/p4/hsa/drivers/hsa/runtime/inc
set HSA_RUNTIME_EXT_INC=F:/p4/hsa/drivers/hsa/compiler/finalizer/Interface
set OCL_PATH=F:/p4/hsa/drivers/opencl/dist/windows/debug
